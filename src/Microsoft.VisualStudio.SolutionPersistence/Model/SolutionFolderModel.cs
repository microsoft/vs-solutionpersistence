...
public sealed class SolutionFolderModel : SolutionItemModel
{
    ...
    public string Name
    {
        ...
        set
        {
            ...
            {
                throw new SolutionArgumentException(string.Format(Errors.DuplicateItemRef_Args2, testName, "Folder"), nameof(value), SolutionArgumentExceptionType.DuplicateItemRef);
            }
